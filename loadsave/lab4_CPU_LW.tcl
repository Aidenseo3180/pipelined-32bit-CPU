...
add_force /CPU/MemoryDataIn -radix bin 10001100011001110000000000000011
...
#4 cycle
#put in memorydatain for now (goes into memorydata register), 10100 = 0x14
add_force /CPU/MemoryDataIn -radix bin 00000000000000000000000000010100
...
#Expected result : content of 0x12 (0x14 in this case) in 00111